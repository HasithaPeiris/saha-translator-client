  ...
  async function selectWord() {
    ...
    try {
      ...
      if (data.sinhala && data.pos) {
        setDefinition(`Sinhala Meaning: ${data.sinhala}, Part of Speech: ${data.pos}`);
      } else {
                ...
                <div className="flex flex-col items-center justify-between xl:flex-row">
                    <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                            ...
                            jumps over a{' '}
                            <span className="text-blue-400">lazy dog</span>
                        </h2>
                    ...
                    <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
                        <div className="App  flex flex-col justify-center items-center bg-gray-100">
                            <div className="border rounded-lg p-6 max-w-lg w-full">
                                <h1 className="text-4xl font-semibold mb-4 text-center">Dictionary</h1>

                                <div id="content" className="p-4 text-2xl">
                                    <b>Content:<br/></b> {wrapWordsInSpans()}
                                </div>
